...
<img src="images/image-408964965.png"
data-fig-alt="Une épave de voiture rouge au milieu d&#39;un désert sur fond d&#39;un champ de pylônes électriques sous un ciel d&#39;orage" />
...
|------------------------|------------------------------------------------------------------------------------------------------------|--------------------------------------------|
| nom_operateur          | opérateur de la station                                                                                    | Freshmile SAS                              |
...
Ces tables peuvent être facilement reliées à l’aide d’une jointure sur
l’identifiant unique de la station service (eg. 100012). Pour être plus
strict, quelques (109) station-services changent d’`id_station` au cours
du temps, et une jointure simultanée sur `latitude` et `longitude` peut
être nécessaire.
...
| Nom de colonne | Description                                  | Exemple   |
|----------------|----------------------------------------------|-----------|
| id_station     | identifiant unique[^1] de la station service | 100012    |
...
- remplies avec les valeurs de l’intervalle précédent s’il n’y a eu
  aucun changement (valeur manquante)

### Détail des ruptures d’approvisionnement en carburant

| Nom de colonne | Description                              | Exemple              |
|----------------|------------------------------------------|----------------------|
| id_pompe       | identifiant unique de la station service | 100012               |
| nom_carburant  | type de carburant                        | SP95                 |
| debut          | début de la rupture de stock             | 2023-02-17T00:01:00Z |
| fin            | fin de la rupture de stock               | 2023-02-19T13:07:00Z |

Descriptif des colonnes des données `ruptures_stations.csv` dans
`essence.zip`
...
téléchargement](https://github.com/ToulouseDataViz/Hackaviz2023/releases/tag/v4)

## Prix aux bornes de recharge pour véhicules électriques

- [borne_de_recharge.xlsx](https://github.com/ToulouseDataViz/Hackaviz2023/releases/download/v4/borne_de_recharge.xlsx)  
- [borne_de_recharge.csv.zip](https://github.com/ToulouseDataViz/Hackaviz2023/releases/download/v4/borne_de_recharge.csv)
...
- [essence_2022.zip - prix à la demi-journée et détail des stations pour
  l’année
  2022](https://github.com/ToulouseDataViz/Hackaviz2023/releases/download/v4/essence_2022.zip)

- [essence_2023-3-8.zip - prix à la demi-journée et détail des stations
  pour l’année 2023 (jusqu’au 8
  mars)](https://github.com/ToulouseDataViz/Hackaviz2023/releases/download/v4/essence_2023-3-8.zip)

- [essence.xlsx - l’ensemble au format
  xlsx](https://github.com/ToulouseDataViz/Hackaviz2023/releases/download/v4/essence.xlsx)

- [essence_hebdomadaire.xlsx - prix agrégés à la semaine pour les années
  2022 et
  2023](https://github.com/ToulouseDataViz/Hackaviz2023/releases/download/v4/essence_hebdomadaire.xlsx)

- [essence_mensuel.xlsx - prix agrégés au mois pour les années 2022 et
  2023](https://github.com/ToulouseDataViz/Hackaviz2023/releases/download/v4/essence_mensuel.xlsx)

- [essence_hebdomadaire.csv.zip](https://github.com/ToulouseDataViz/Hackaviz2023/releases/download/v4/essence_hebdomadaire.csv.zip)
  et
  [essence_mensuel.csv.zip](https://github.com/ToulouseDataViz/Hackaviz2023/releases/download/v4/essence_mensuel.csv.zip)

## Les départements français

[departements_france.csv](https://github.com/ToulouseDataViz/Hackaviz2023/releases/download/v4/departements-france.csv)
...
[^1]: hors modification de l’adresse ou passage en automate.
